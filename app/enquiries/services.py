...
from app.utils import sast_today, sast_now
...
def start_progress(enquiry: Enquiry):
    ...
    enquiry.in_progress_at = sast_now()
    db.session.commit()
    return enquiry
